            ...
            else
            {
                ...
                try
                {
                    ...
                    switch (type.ToLower())
                    {
                        ...
                        case "uint32":
                        case "single":
                            val = Convert.ToSingle((Convert.ToSingle(value) * Convert.ToSingle(scale) + Convert.ToSingle(offset)).ToString("N4"));
                            break;
                        case "int64":
                        case "uint64":
                        case "double":
                            val = Convert.ToDouble((Convert.ToDouble(value) * Convert.ToDouble(scale) + Convert.ToDouble(offset)).ToString("N4"));
                            break;
                        default:
                            val = value;
                            break;
